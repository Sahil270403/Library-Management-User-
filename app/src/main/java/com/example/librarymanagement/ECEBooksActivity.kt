...
import com.example.librarymanagement.databinding.ActivityEcebooksBinding
import com.example.librarymanagement.models.book_details
import com.google.firebase.database.*

class ECEBooksActivity : AppCompatActivity() {

    private lateinit var database : DatabaseReference
    private lateinit var binding : ActivityEcebooksBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityEcebooksBinding.inflate(layoutInflater)
    ...
    private fun readAllData() {
        ...
        database.addValueEventListener(object : ValueEventListener {
            ...
            override fun onCancelled(error: DatabaseError) {
                Toast.makeText(this@ECEBooksActivity,"Failed to read data", Toast.LENGTH_SHORT).show()
            }
        })
    }
