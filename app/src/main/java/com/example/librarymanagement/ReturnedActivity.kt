...
class ReturnedActivity : AppCompatActivity() {
    ...
    private lateinit var binding:ActivityReturnedBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityReturnedBinding.inflate(layoutInflater)
        setContentView(binding.root)

        userRecyclerview = binding.sortNameRecyclerView3
