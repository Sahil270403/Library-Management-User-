...
import com.example.librarymanagement.databinding.ActivityCsebooksBinding
import com.example.librarymanagement.models.book_details
import com.google.firebase.database.*

class CSEBooksActivity : AppCompatActivity() {

    private lateinit var database : DatabaseReference
    private lateinit var binding : ActivityCsebooksBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityCsebooksBinding.inflate(layoutInflater)
    ...
    private fun readAllData() {
        ...
        database.addValueEventListener(object : ValueEventListener {
            ...
            override fun onCancelled(error: DatabaseError) {
                Toast.makeText(this@CSEBooksActivity,"Failed to read data", Toast.LENGTH_SHORT).show()
            }
        })
    }
